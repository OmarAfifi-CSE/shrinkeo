...
class AppLocalizationsUk extends AppLocalizations {
  ...
  @override
  String get dragDropMoreMsg => 'Або перетягніть ще файли будь-куди';
  ...
  @override
  String get filesPlural => 'файлів';

  @override
  String get releaseToAddVideosMsg => 'Відпустіть, щоб додати файли';

  @override
  String get dragDropHereMsg => 'Перетягніть відео або зображення сюди';

  @override
  String get supportedFormatsMsg =>
      'Підтримує MP4, MKV, MOV, AVI, WMV, WebM • PNG, JPG, WebP, AVIF та інші';
  ...
  @override
  String get imageQualityModeLabel => 'Рівень якості';

  @override
  String get imageQualityModeDesc =>
      'Кодує на фіксованому рівні якості — вища якість означає більші файли.';

  @override
  String get imageTargetSizeModeLabel => 'Цільовий розмір';

  @override
  String get imageTargetSizeModeDesc =>
      'Автоматично знаходить найвищу якість, яка вміщується в ліміт розміру.';

  @override
  String get imageQualitySliderTitle => 'Якість зображення';

  @override
  String get imageTargetSizeTitle => 'Цільовий розмір файлу';

  @override
  String get imageTargetSizeDesc =>
      'Кодує повторно зі знижувальною якістю, поки файл не вміститься в ліміт. Дуже малі ліміти можуть знизити якість.';
  ...
  @override
  String get customKbSizeTooltip => 'Введіть власний розмір у КБ';

  @override
  String get imageProcessingFailedError => 'Не вдалося обробити зображення';

  @override
  String get imageProcessingErrorMsg => 'Помилка обробки зображення';
  ...
  String notifyCompressionCompleteSuccess(String success) {
    return 'Успішно стиснуто файли: $success.';
  }
  ...
  @override
  String get imagePreparing => 'Підготовка зображення';

  @override
  String get imageEncoding => 'Стиснення зображення';

  @override
  String get imageSaving => 'Збереження результату';

  @override
  String imageTargetProgress(String size) {
    return 'Цільовий розмір: $size';
  }
  ...
  String imageBestResult(String size) {
    return 'Найкращий результат: $size';
  }

  @override
  String queueCompleted(int done, int total) {
    return 'Завершено $done із $total';
  }

  @override
  String get outputPreservedOriginalTooltip =>
      'Оригінальний файл збережено автоматично, оскільки стиснення збільшило б його розмір.';

  @override
  String get retryFileTooltip => 'Повторити обробку цього файлу';

  @override
  String get pauseBtn => 'Пауза';

  @override
  String get resumeBtn => 'Продовжити';

  @override
  String get pausingBtn => 'Призупинення...';

  @override
  String get pausedLabel => 'Призупинено';

  @override
  String get compareImagesTooltip => 'Порівняти до і після';

  @override
  String get compareImagesTitle =>
      'Порівняння зображення до та після стиснення';

  @override
  String get originalLabel => 'Оригінал';

  @override
  String get compressedLabel => 'Стиснутий';

  @override
  String get dragToCompare => 'Потягніть повзунок для порівняння';

  @override
  String get resetZoomTooltip => 'Скинути масштаб';

  @override
  String get imageFilesNotFound =>
      'Один або обидва файли зображень не знайдено на диску для порівняння.';
}
