...
class AppLocalizationsBn extends AppLocalizations {
  ...
  @override
  String get crfLossless => 'ক্ষতিহীন';

  @override
  String get crfHighQuality => 'উচ্চ গুণমান';

  @override
  String get crfBalanced => 'সুষম';

  @override
  String get crfHighCompression => 'উচ্চ কম্প্রেশন';

  @override
  String get crfLowQuality => 'নিম্নমানের';

  @override
  String get crfUltraCompressed => 'আল্ট্রা সংকুচিত';
  ...
  @override
  String get dragDropMoreMsg => 'অথবা আরও ফাইল যেকোনো জায়গায় টেনে আনুন';
  ...
  @override
  String get fileSingle => 'ফাইল';

  @override
  String get filesPlural => 'ফাইল';

  @override
  String get releaseToAddVideosMsg => 'ফাইল যোগ করতে ছেড়ে দিন';

  @override
  String get dragDropHereMsg => 'ভিডিও বা ছবি এখানে টেনে আনুন';

  @override
  String get supportedFormatsMsg =>
      'MP4, MKV, MOV, AVI, WMV, WebM • PNG, JPG, WebP, AVIF সমর্থিত';
  ...
  String customRatioActiveTitle(Object ratio) {
    return 'কাস্টম অনুপাত ($ratio)';
  }

  @override
  String customRatioActiveDesc(Object ratio) {
    return 'কাস্টম $ratio অনুপাতের জন্য প্যাড করা ক্যানভাস।';
  }

  @override
  String customAngleActiveTitle(Object angle) {
    return 'কাস্টম কোণ ($angle°)';
  }

  @override
  String customAngleActiveDesc(Object angle) {
    return 'ভিডিওটিকে কাস্টম $angle° ডিগ্রি কোণে ঘোরায়।';
  }

  @override
  String trimActiveDesc(Object end, Object start) {
    return 'কাস্টম $start এবং $end এর মধ্যে ভিডিও ক্লিপ কাটে।';
  }

  @override
  String targetSizeLimitLabel(Object size) {
    return '$size মেগাবাইট সীমা';
  }

  @override
  String get customMbSizeTooltip => 'কাস্টম মেগাবাইট আকার লিখুন';

  @override
  String get trimTimeTooltip =>
      'সময় লিখুন যেমন 5 (5s), 1:30 (1m30s), অথবা 00:01:30';

  @override
  String get tabImageSuite => 'ইমেজ স্যুট';

  @override
  String get compressionModeTitle => 'কম্প্রেশন মোড';

  @override
  String get smartAutoLabel => 'স্মার্ট অটো';

  @override
  String get smartAutoDesc =>
      'স্বয়ংক্রিয়ভাবে ফাইলের আকার ~60-80% কমিয়ে 100% আদিম দৃশ্য স্পষ্টতার সাথে। দৈনন্দিন ফটো অপ্টিমাইজেশান জন্য পারফেক্ট.';

  @override
  String get maxSavingsLabel => 'সর্বোচ্চ সঞ্চয়';

  @override
  String get maxSavingsDesc =>
      'আক্রমনাত্মক কম্প্রেশন 85-90% ফাইল আকার পর্যন্ত সংরক্ষণ করে। দ্রুত মেসেজিং, ওয়েব আপলোড এবং ইমেল সংযুক্তির জন্য সেরা।';

  @override
  String get ultraFidelityLabel => 'আল্ট্রা ফিডেলিটি';

  @override
  String get ultraFidelityDesc =>
      'ন্যূনতম সংকোচনের সাথে কাঁচা চাক্ষুষ বিশ্বস্ততা সংরক্ষণ করে। ফটোগ্রাফি সংরক্ষণাগার এবং উচ্চ-রেজোলিউশন প্রিন্ট কাজের জন্য আদর্শ।';

  @override
  String get targetImageFormatTitle => 'টার্গেট ইমেজ ফরম্যাট';

  @override
  String get dimensionResizingTitle => 'ডাইমেনশন রিসাইজিং';

  @override
  String get exifCameraPrivacyTitle => 'EXIF / ক্যামেরা গোপনীয়তা';

  @override
  String get stripGpsCameraInfoLabel => 'স্ট্রিপ জিপিএস এবং ক্যামেরা তথ্য';
  ...
  @override
  String get imageQualityModeLabel => 'কোয়ালিটি স্তর';

  @override
  String get imageQualityModeDesc =>
      'নির্দিষ্ট কোয়ালিটি স্তরে এনকোড করে — উচ্চ কোয়ালিটি মানে বড় ফাইল।';

  @override
  String get imageTargetSizeModeLabel => 'লক্ষ্য আকার';

  @override
  String get imageTargetSizeModeDesc =>
      'স্বয়ংক্রিয়ভাবে সর্বোচ্চ কোয়ালিটি খুঁজে বের করে যা নির্দিষ্ট আকারের মধ্যে ফিট করে।';

  @override
  String get imageQualitySliderTitle => 'ছবির কোয়ালিটি';

  @override
  String get imageTargetSizeTitle => 'লক্ষ্য ফাইলের আকার';

  @override
  String get imageTargetSizeDesc =>
      'ফাইলটি সীমার মধ্যে না আসা পর্যন্ত ক্রমহ্রাসমান কোয়ালিটিতে এনকোড করে। খুব ছোট সীমা কোয়ালিটি কমিয়ে দিতে পারে।';
  ...
  @override
  String get customKbSizeTooltip => 'কাস্টম KB আকার লিখুন';

  @override
  String get imageProcessingFailedError => 'ছবি প্রসেসিং ব্যর্থ হয়েছে';

  @override
  String get imageProcessingErrorMsg => 'ছবি প্রসেসিং ত্রুটি';

  @override
  String get cleanNoiseLabel => 'শব্দ পরিষ্কার করুন';

  @override
  String get outputLargerTooltip =>
      'আউটপুট মূল ফাইলের চেয়ে বড় হবে!\nথামান এবং ডিফল্টে রিসেট করুন।';
  ...
  String notifyCompressionCompleteSuccess(String success) {
    return 'সফলভাবে $success টি ফাইল কমপ্রেস করা হয়েছে।';
  }
