...
class AppLocalizationsUr extends AppLocalizations {
  ...
  @override
  String get dragDropMoreMsg => 'یا مزید فائلیں کہیں بھی کھینچ کر چھوڑیں';
  ...
  @override
  String get fileSingle => 'فائل';

  @override
  String get filesPlural => 'فائلیں';

  @override
  String get releaseToAddVideosMsg => 'فائلیں شامل کرنے کے لیے چھوڑیں';

  @override
  String get dragDropHereMsg => 'ویڈیوز یا تصاویر یہاں کھینچیں اور چھوڑیں';

  @override
  String get supportedFormatsMsg =>
      'MP4, MKV, MOV, AVI, WMV, WebM • PNG, JPG, WebP, AVIF اور مزید سپورٹ کرتا ہے';
  ...
  String customRatioActiveTitle(Object ratio) {
    return 'حسب ضرورت تناسب ($ratio)';
  }

  @override
  String customRatioActiveDesc(Object ratio) {
    return 'حسب ضرورت $ratio تناسب کے لیے پیڈڈ کینوس۔';
  }

  @override
  String customAngleActiveTitle(Object angle) {
    return 'حسب ضرورت زاویہ ($angle°)';
  }

  @override
  String customAngleActiveDesc(Object angle) {
    return 'ویڈیو کو حسب ضرورت $angle° ڈگری زاویہ پر گھماتا ہے۔';
  }

  @override
  String trimActiveDesc(Object end, Object start) {
    return 'ویڈیو کلپ کو $start اور $end کے درمیان کاٹتا ہے۔';
  }

  @override
  String targetSizeLimitLabel(Object size) {
    return '$size ایم بی حد';
  }

  @override
  String get customMbSizeTooltip => 'حسب ضرورت ایم بی سائز ٹائپ کریں';
  ...
  @override
  String get imageQualityModeLabel => 'کوالٹی لیول';

  @override
  String get imageQualityModeDesc =>
      'مقررہ کوالٹی لیول پر انکوڈ کرتا ہے — زیادہ کوالٹی کا مطلب بڑی فائلیں۔';

  @override
  String get imageTargetSizeModeLabel => 'ہدف سائز';

  @override
  String get imageTargetSizeModeDesc =>
      'خودکار طور پر اعلیٰ ترین کوالٹی تلاش کرتا ہے جو سائز کی حد میں فٹ ہو۔';

  @override
  String get imageQualitySliderTitle => 'تصویر کی کوالٹی';

  @override
  String get imageTargetSizeTitle => 'ہدف فائل سائز';

  @override
  String get imageTargetSizeDesc =>
      'فائل کے حد میں فٹ ہونے تک کم ہوتی کوالٹی کے ساتھ بار بار انکوڈ کرتا ہے۔ بہت چھوٹی حد کوالٹی کم کر سکتی ہے۔';
  ...
  @override
  String get customKbSizeTooltip => 'اپنی مرضی کا KB سائز لکھیں';

  @override
  String get imageProcessingFailedError => 'تصویر کی پروسیسنگ ناکام';

  @override
  String get imageProcessingErrorMsg => 'تصویر کی پروسیسنگ میں خرابی';

  @override
  String get cleanNoiseLabel => 'شور کو ختم کریں';

  @override
  String get outputLargerTooltip =>
      'آؤٹ پٹ فائل اصل سے بڑی ہو گی!\nروکیں اور ڈیفالٹ پر ری سیٹ کریں۔';
  ...
  String notifyCompressionCompleteSuccess(String success) {
    return '$success فائلیں کامیابی سے کمپریس ہوئیں۔';
  }
  ...
  @override
  String get imagePreparing => 'تصویر تیار ہو رہی ہے';

  @override
  String get imageEncoding => 'تصویر کمپریس ہو رہی ہے';

  @override
  String get imageSaving => 'نتیجہ محفوظ ہو رہا ہے';
  ...
  String get outputPreservedOriginalTooltip =>
      'اصل فائل خودکار طور پر محفوظ کر لی گئی کیونکہ کمپریشن سے اس کا سائز بڑھ جاتا۔';

  @override
  String get retryFileTooltip => 'اس فائل کو پروسیس کرنے کی دوبارہ کوشش کریں';

  @override
  String get pauseBtn => 'وقفہ';

  @override
  String get resumeBtn => 'دوبارہ شروع کریں';

  @override
  String get pausingBtn => 'روکا جا رہا ہے...';

  @override
  String get pausedLabel => 'روک دیا گیا';

  @override
  String get compareImagesTooltip => 'پہلے اور بعد کا موازنہ کریں';

  @override
  String get compareImagesTitle =>
      'کمپریشن سے پہلے اور بعد میں تصویر کا موازنہ';

  @override
  String get originalLabel => 'اصل';

  @override
  String get compressedLabel => 'کمپریسڈ';

  @override
  String get dragToCompare => 'موازنہ کرنے کے لیے سلائیڈر کو گھسیٹیں';

  @override
  String get resetZoomTooltip => 'زوم ری سیٹ کریں';

  @override
  String get imageFilesNotFound =>
      'موازنہ کے لیے ڈسک پر ایک یا دونوں امیج فائلیں نہیں مل سکیں۔';
}
